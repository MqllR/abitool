...
func init() {
DownloadCmd.Flags().String("label", "", "Optional human-friendly label for the contract (overrides Etherscan name in display)")
}
...
err = abiManager.DownloadAndStoreABI(ctx, args[0], label)
if err != nil {
